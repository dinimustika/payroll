            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-l-10">
                                    <a href="#" class="" id="Userdd" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <h5 class="m-b-0 user-name font-medium"><?= session()->get('Username') ?> <i class="fa fa-angle-down"></i></h5>
                                        <span class="op-5 user-email"><?= session()->get('UserEmail') ?> </span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="Userdd">
                                        @if(!empty(session()->get('id')))
                                        <a class="dropdown-item" href="{{url('profile/'.session()->get('id'))}}"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="{{url('/logout')}}"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                                        @else
                                        <a class="dropdown-item" href="{{url('login')}}"><i class="ti-user m-r-5 m-l-5"></i> Login</a>
                                        @endif                                        
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/payrolls') }}" aria-expanded="false"><i class="mdi mdi-credit-card"></i><span class="hide-menu">Payrolls</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/attendances') }}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Attendances</span></a></li>
                        @else
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/') }}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/attendances/'.session()->get('id'))}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Attendance</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/payrolls/'.session()->get('id'))}}" aria-expanded="false"><i class="mdi mdi-credit-card"></i><span class="hide-menu">Payrolls</span></a></li>
                        @endif
